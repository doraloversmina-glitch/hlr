...
BEGIN
    ...
    -- =============================================================================================
    -- NOTE: ALL REMAINING PHASES (3-6) WILL BE INSERTED HERE FROM COMBINED FILE
    -- Due to size constraints, the complete logic is in:
    -- /home/user/hlr/all_remaining_phases_combined.sql
    -- This includes:
    -- - Phase 3: HLR1/HLR2 merge + 20 NULL-to-zero updates
    -- - Mismatch reports (MSISDN and IMSI)
    -- - Phase 4: Final merge with SDP assignment
    -- - Phase 5: APN companion product reports
