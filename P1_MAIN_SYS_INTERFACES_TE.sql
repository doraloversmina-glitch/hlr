PROCEDURE P1_MAIN_SYS_INTERFACES_TE(
    ...
    --    Requirement  version        : V4.0
    --    Comments                    : Reconciliation with Enhanced Tracing
    -- =============================================================================================
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
            DBMS_OUTPUT.PUT_LINE('Error logging activity: ' || SQLERRM);
    END LOG_ACTIVITY_TE;
...
BEGIN
    ...
    -- ================================================================================================================
    -- Create Activity Trace Table if not exists
    -- ================================================================================================================
    BEGIN
        EXECUTE IMMEDIATE 'SELECT COUNT(*) FROM P1_ACTIVITY_TRACE_TE WHERE ROWNUM = 1' INTO v_rows_affected;
    EXCEPTION
        WHEN OTHERS THEN
            EXECUTE IMMEDIATE '
